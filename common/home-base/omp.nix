  ...
  modelsConfig = {
    providers.cliproxyapi = {
      ...
      models = [
        ...
        (mkModel "claude-opus-4-7" 200000 32000 false)
        (mkModel "claude-fable-5" 200000 32000 false)
        (mkModel "claude-sonnet-4-6" 200000 64000 false)
        (mkModel "claude-sonnet-4-5-20250929" 200000 64000 false)
        (mkModel "claude-sonnet-4-20250514" 200000 64000 false)
        (mkModel "claude-haiku-4-5-20251001" 200000 16000 false)
        (mkModel "claude-opus-4-20250514" 200000 32000 false)
        (mkModel "claude-opus-4-5-20251101" 200000 32000 false)
        (mkModel "claude-opus-4-1-20250805" 200000 32000 false)
        (mkModel "claude-opus-4-6" 200000 32000 false)
        (mkModel "claude-opus-4-6-thinking" 200000 32000 true)
        (mkModel "claude-3-7-sonnet-20250219" 200000 64000 true)
        (mkModel "claude-3-5-haiku-20241022" 200000 8192 false)
